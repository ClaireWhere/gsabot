...
module.exports = {
  async execute(interaction) {
    ...
    const button = new ButtonBuilder({
        ...
        label: `I agree to the politics rules`,
        custom_id: `politics`,
        disabled: false,
    });
    ...
    const embed_2 = {
        ...
        fields: [
            ...
            {
                "name": `‎\n3️⃣ No name-calling or insulting`,
                "value": `No matter how extreme someone's views are, please refrain from using slurs or demeaning language toward them. Instead, share what bothers you. Try not to get heated.`
            },
            {
    ...
    const embed_3 = {
        title: `❗ By agreeing below, you acknowledge that you have read the rules and understand the purpose and appropriate use of the \`\`\`#politics\`\`\` channel.`,
        description: `You agree that you will continue to be respectful to others and sensitive to everyone's feelings regarding political issues. Please keep the things discussed in the ${politics} channel in this channel only. \n\nThis role may be removed at any time if you are not using this space appropriately and you will be messaged about it. Please note if you are removed, you are not in trouble, we will just not issue warnings for ${politics} as it is a highly sensitive place.\n\nClick this button again to remove ${politics} from your view at any time\n`,
        color: parseInt(config.colors.light_red.darken[0].hex),

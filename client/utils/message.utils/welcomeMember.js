...
const { getChannelParentName, getRandomName } = require("../utils");
...
async function welcomeMember(interaction) {
    ...
    await welcome.send({ content: `${interaction.member}`, 
	embeds: [{
            title: ``,
            description: `# Welcome to the SAGE Discord Server!\nEveryone say hi to ${interaction.member}! Feel free to introduce yourself in ${introductions} and choose your ${roles}`,

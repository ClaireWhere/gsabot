...
module.exports = {
    async execute(interaction) {
        ...
        const embed2 = {
            ...
            fields: [
                ...
                },
                {
                    ...
                    "value": `${safeSpace} is not a place for mental health crises. Please understand this is not because we don't want you to talk about your mental health, but none of us are mental health professionals and there is only so much we can help. As much as we want to offer you support, there are limits to the type and amount of support you should be receiving. Please call or text 988, chat 988lifeline.org or call 911 if you are having a mental heath crisis\n>>> Additionally, keep in mind there may be mandated reporters (i.e. GSC Coordinator, GSC Graduate Assistant, GSC Peer Mentors, etc.) in this space. While they are encouraged to remove themselves from ${safeSpace}, they are required by law to report mental health emergencies to the university.`
                }
            ],
        };
        ...
        const safeSpaceAgreement = { content: ``, embeds: [embed1, embed2, embed3], components: [row] }
        return safeSpaceAgreement;
    }
}